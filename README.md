...
| **[Local Lakehouse (VibeCoded)](https://github.com/ericmartinezr/local_lakehouse)** | Lakehouse local con un frontend para interactuar | `Floci`, `Apache Polaris`, `Apache Iceberg`, `Duckdb`, `Trino`, `OpenCode`
